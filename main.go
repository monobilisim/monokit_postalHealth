// postalHealth plugin for monokit2 — Postal health: services, containers, MySQL, message and held queues.
//
...
var pluginName string = "postalHealth"
...
var configFiles []string = []string{"mail.yml"}
